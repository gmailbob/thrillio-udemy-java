...
public class Book extends Bookmark implements Shareable {
	...
	public String getItemData() {
		...
		/*-
		since 1.8 String.join is a built-in function:
		builder.append("<authors>").append(String.join(",", authors)).append("</authors>");
		
		practice adding a 3rd library
		right click project -> properties -> java build path -> libraries -> classpath -> add external jars
		*/
